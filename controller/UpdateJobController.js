...
UpdateJobController.updateJob = async(req, res) => {
    req.setTimeout(0);
    try {
        // await UpdateJobService.openUpdatePage(req.body.id);
        ...
        if (req.body.description) {
            // await UpdateJobService.updateDescriptionSection(req.body.description);
        }
        //update job service
        if (req.body.budget || req.body.maxCPC || req.body.budgetEndDate) {
            // await UpdateJobService.updateSponsorJobSection(req.body.budget, req.body.maxCPC, req.body.budgetEndDate);
        }
